...
export default function Review({visible,close,id,updaterev}) {
        ...
        <StatusBar/>
           <View style={{flex:1,display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"rgba(0,0,0,0.2)"}}>
            <View style={{height:300,width:"90%",borderRadius:10,backgroundColor:colors.white,display:"flex",alignItems:"center",justifyContent:"center"}}>
                ...
                <TextInput onChangeText={(e)=>setreview(e)} style={{width:"90%",paddingHorizontal:10,marginVertical:15,paddingVertical:10,borderWidth:1,borderRadius:10,borderColor:colors.black}} placeholder='Review'/>
                    <TouchableOpacity style={{backgroundColor:colors.primary,paddingHorizontal:15,paddingVertical:12,borderRadius:4,display:"flex",justifyContent:"center",alignItems:"center"}} onPress={()=>{
                      close()
                      updaterev(id,review)
                    }}>
